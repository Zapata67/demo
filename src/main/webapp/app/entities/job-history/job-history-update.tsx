          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : jobHistoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                >
                  <option value="FRENCH">{translate('demoApp.Language.FRENCH')}</option>
                  <option value="ENGLISH">{translate('demoApp.Language.ENGLISH')}</option>
                  <option value="SPANISH">{translate('demoApp.Language.SPANISH')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
